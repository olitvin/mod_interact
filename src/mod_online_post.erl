...
%%% File    : mod_online_post.erl
%%% Author  : Adam Duke <adam.v.duke@gmail.com>
%%% Purpose : Forward online messages to an arbitrary url
...
start(Host, Opts) ->
    ?INFO_MSG("Starting mod_online_post", [] ),
...
stop(Host) ->
    ?INFO_MSG("Stopping mod_online_post", [] ),
    ejabberd_hooks:delete(online_message_hook, Host,
